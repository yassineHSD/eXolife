...
function PulsationTimingVariations(props){
    var m=0;
    var object = props.data.map( (object,i)=> {
      if(object["pl_discmethod"]==="Pulsation Timing Variations"){
        m++;
        return (
  ...
  return(
    <React.Fragment >
      <section  className="allContent sectio" >
...
export default PulsationTimingVariations;
